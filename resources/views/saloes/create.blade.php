            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav align-items-lg-center ms-auto me-lg-5">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="index.html#section_2">Conheça</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="index.html#section_5">Ajuda</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="index.html#section_6">Login</a>
                        </li>
                    </ul>

                    <a href="ticket.html" class="btn custom-btn d-lg-block d-none">Cadastro</a>
                </div>
            </div>
        </nav>
