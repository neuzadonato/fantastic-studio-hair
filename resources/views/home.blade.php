...
<head>
    ...
    <title>Fantastic Studio Hair</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-4 mb-lg-0 d-flex align-items-center">
                        <div class="services-info">
                            <h2 class="text-white mb-4">De onde surgimos?</h2>

                            <p class="text-white">Somos de um grupo de Técnicos de Desenvolvimento de Sistemas do interior de São Paulo,
                                que desenvolvemos o TCC na modalidade de um site, para fins de facilitar agendamentos de salões de beleza entre o cliente e a empresa.</p>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 text-center">
                        <h2 class="mb-4">Diversos Serviços Para Você!</h1>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        <h2 class="text-center mb-4">Precisa de ajuda ?</h2>
                    </div>
                                ...
                                <form class="custom-form contact-form mb-5 mb-lg-0" action="#" method="post"
                                    ...
                                    <div class="contact-form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-12">
                                                <input type="email" name="contact-senha" id="contact-senha"
        ...
        <div class="site-footer-top">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <h2 class="text-white mb-lg-0">Fantastic Studio Hair</h2>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                    <h5 class="site-footer-title mb-3">Fale conosco</h5>

                    <p class="text-white d-flex mb-1">
                        <a href="tel: (18) 98826-3406" class="site-footer-link">
                            (18) 98826-3406
                        </a>
                    </p>

                    <p class="text-white d-flex">
                        <a href="raissaleal535@gmail.com" class="site-footer-link">
                            raissaleal535@gmail.com
                        </a>
                    </p>
                </div>
